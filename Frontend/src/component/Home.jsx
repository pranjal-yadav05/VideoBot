    ...
    return (
        ...
        >
            ...
            <p
                ...
                style={{ fontFamily: 'Roboto Condensed, sans-serif', fontSize: '1.2em' }}
            >
            ...
            <div className="flex space-x-4 mt-8"> {/* Container for buttons with space between them */}
                <button
                    className="bg-gray-800 hover:bg-gray-700 text-gray-200 rounded-lg py-4 px-8 transition-transform transform hover:scale-110 focus:outline-none"
                    onClick={handleVidBot}
                >
                    Get Started with VidBot
                </button>
                <button
                    className="bg-blue-600 hover:bg-blue-500 text-white rounded-lg py-4 px-8 transition-transform transform hover:scale-110 focus:outline-none"
                    onClick={handlVidBotPro}
                >
                    Explore VidBot Pro
                </button>
            </div>
